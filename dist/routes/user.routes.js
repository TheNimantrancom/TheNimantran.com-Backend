...
import { getCurrentUser, googleCallbackLogin, loginUser, logoutUser, refreshAccessToken, registerUser, resetPassword, updateProfile } from "../controllers/user.controller.js";
import { verifyJWT } from "../middlewares/auth.middleware.js";
import { addToCart, emptyCart, getCartCards, removeCartCard, totalCartAmount, updateCartCardQuantity, } from "../controllers/cart.controller.js";
...
import { cancelOrder, createOrder, getCertainOrder, getUserOrders } from "../controllers/order.controller.js";
...
router.get("/auth/google/callback", passport.authenticate("google", { failureRedirect: "https://thenimantran.com/login", session: false }), googleCallbackLogin);
...
router.get("/orders/:orderId/invoice", verifyJWT, downloadInvoice);
// Address
